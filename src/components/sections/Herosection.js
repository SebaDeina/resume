  ...
  return (
    ...
    >
      <div className="container">
        <div className="intro">
          <img src="images/perfil2.png" alt="Bolby" className="mb-4" />

          <h1 className="mb-2 mt-0">Sebastian Deina</h1>
          <p>
            Soy {" "}
            <Typed
              strings={[
          ...
          <ul className="social-icons light list-inline mb-0 mt-4">
            <li className="list-inline-item">
              <a href="https://www.instagram.com/seba_deina/">
                <i className="fab fa-instagram"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://twitter.com/sebadeina">
                <i className="fab fa-twitter"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://dribbble.com/Sebadeina">
